...
@Component({
  ...
  imports: [],
  templateUrl: './disaster-locations.component.html',
  styleUrl: './disaster-locations.component.scss'
})
export class DisasterLocationsComponent implements AfterViewInit {
