...
export class DonorDisasterLobbyComponent implements AfterViewInit {
  ...
  protected readonly volunteerList = [
    { name: '花蓮縣光復鄉衛生所', location: '📍花蓮縣光復鄉大馬村中學街158號', lat: 23.671898, lng: 121.425941, needs: ['物資搬運', '環境清潔', '災民陪伴'] },
    { name: '花蓮縣立光復國民中學', location: '📍花蓮縣光復鄉大馬村林森路200號', lat: 23.670939, lng: 121.426511, needs: ['物資整理', '物資搬運'] },
    { name: '花蓮縣鳳林鎮長橋國民小學', location: '📍花蓮縣鳳林鎮長橋里長橋路2號', lat: 23.709583, lng: 121.419539, needs: ['災民服務', '物資發放', '環境整理'] }
  ];

  protected readonly donationList = [
    { name: '花蓮縣光復鄉衛生所', location: '📍花蓮縣光復鄉大馬村中學街158號', lat: 23.671898, lng: 121.425941, needs: ['飲用水', '泡麵', '罐頭食品'] },
    { name: '花蓮縣光復鄉西南社區發展協會', location: '📍花蓮縣光復鄉南富村建國路二段111號', lat: 23.658455, lng: 121.449389, needs: ['奶粉', '尿布', '衛生用品'] },
    { name: '大進國小災民收容所', location: '📍花蓮縣光復鄉大進村糖廠街2號', lat: 23.654699, lng: 121.419135, needs: ['礦泉水', '乾糧', '清潔用品'] }
  ];
