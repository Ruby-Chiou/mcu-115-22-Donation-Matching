...
export class DonorDisasterLobbyComponent {protected readonly newsList: disasterItem[] = [
    ...
    },
    {
      ...
      text: '米克拉颱風災害救援支持行動',
      highlight: '受米克拉颱風外圍環流及強烈西南氣流影響，全台各地降下驚人雨量，短時間內累積雨量突破歷史紀錄。屏東部分地區累積雨量超過500毫米，高雄美濃、大樹、台南、屏東等地陸續傳出嚴重積淹水，道路坍方、住家進水，居民被迫撤離家園；花蓮萬里溪上游堰塞湖更因暴雨水位暴漲，存在潰壩風險，下游居民緊急撤離避難。',
    },
  ];
