...
export class DisasterHistoryComponent {
  showSuccessModal = false;
  constructor(private router: Router) {}
  donate(disasterId: number) {
    // 讀取管理者針對這個災害設定的狀態
    const savedStatus = localStorage.getItem(`disaster_${disasterId}`);
  ...
  protected readonly sections = signal<DisasterSection[]>([
    ...
    },
    {
      ...
      description:
        ...
        '以及其他地區災情的增加。',
      backgroundImage:
        'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcS6ip85lncdFZNoJoistp_g0g7Ppja2qWfW7g9K0Hm9CS8Ju-SCWU8GpAs&s=10',
